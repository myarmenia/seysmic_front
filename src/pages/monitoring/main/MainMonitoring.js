...
import { Container, CustomUl, Title, TitleBorder } from '../../../components/reusable';
import {
  AllQuakes,
  Describtion,
  HaitiExample,
...
const data = [
  {
    src: tableImg1,
    describtion: 'Граница плит спрединг – плиты расходятся и образуется новая кора (Тип А)',
  },
  {
    src: tableImg1,
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(269.98deg, #0026AA -1.43%, #1267CB 51.39%, #0026AA 99.98%)',
        }}>
        {/* <img
