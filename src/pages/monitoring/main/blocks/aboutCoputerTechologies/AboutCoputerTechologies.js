...
export const AboutCoputerTechologies = () => {
  ...
  return (
    <Container className="mb-[115px]">
      ...
      <Ul
        className={[styles.list, "mt-8"].join(" ")}
        data={language.Pyramid.texts}
      />
      ...
      />
      <Title className="mb-4 mt-11">
        {language.Prediction_Probability.title}
      </Title>
      ...
      <div className="mt-11 flex justify-between gap-5  med-600:flex-col-reverse">
        <div className="w-1/2 med-600:w-full">
          ...
          <Ul
            ...
            data={language.Prediction_Probability.texts}
          />
        </div>
        <img
          alt=""
