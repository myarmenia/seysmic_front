  ...
  return (
    <Container className="mb-[115px]">
      <Title className="mb-4">
        МЕТОД СЕЙСМИЧЕСКОЙ ЭНТРОПИИИ (МСЭ) И КОПMПЬЮТЕРНАЯ ТЕХНОЛОГИЯ (LMTP-SPQ)
        ДЛЯ МОНИТОРИНГА И ПРОГНОЗА
      </Title>
      <TitleBorder
        title={
      ...
      <p className="mt-8 text-[18px] leading-[168.5%] text-justify med-600:text-sm">
        Разработанная нами технология мониторинга и прогноза основана на законе
        производства сейсмической энтропии Акопян, 2013г.
        <a href="/" className="inline">
          <img alt="" className="inline" loading="lazy" src={file_pdf} />
        </a>
        . Этот закон просматривается только в рамках новых сейсмических
        параметров, рассчитываемых на основе самой надежной и прозрачной
        информации – каталогов землетрясений. Метод сейсмической энтропии не
        противоречит всему тому, что накоплено, наработано специалистами в
        области прогноза землетрясений и снижения сейсмического риска, он,
        наоборот, позволяет объединить эти усилия и существенно поднять их
        эффективность, повышая сопротивляемость общества к природным
        катастрофам, а также способствовать эффективному распределению финансов
        и целевой подготовке к сильным землетрясениям. Метод ввиду своей
        универсальности и надежности, уже сегодня дает возможность создать
        многоуровневую (глобальную, региональную, национальную и локальную)
        автоматизированную информационную систему сейсмического контроля. Более
        того, для хорошо определенных сейсмических систем (например, Италии,
        Японии, Калифорнии) можно сделать и надежный краткосрочный прогноз. Мы
        считаем, что метод сейсмической энтропии, по своей универсальности,
        прозрачности, надежности и высокой эффективности является как раз тем
        инструментом, на основе которого уже сегодня могут объединять свои
        усилия сейсмологи и правительства разных стран мира для разработки
        единых международных норм и правил прогноза, оповещения и принятия мер в
        случае сейсмической опасности
      </p>
