...
export const AboutCoputerTechologies = () => {
  ...
  console.log(language.Diagram_Prediction.title);
  const data = [
  ...
  return (
    <Container className="mb-[115px]">
      ...
      <div className="flex justify-between gap-5 med-600:flex-col med-600:justify-center med-600:items-center">
        <img alt="" src={seismicSystem} className="object-contain w-[44.99%] med-600:w-full " />
        <img alt="" src={entropyproduction} className="w-1/2 object-contain med-600:w-full" />
      </div>
      ...
      <div className="flex justify-between gap-5 med-600:flex-col med-600:justify-center med-600:items-center ">
        <img alt="" src={attreactor} className="object-contain w-1/2 med-600:w-full" />
        <img alt="" src={attreactor2} className="w-1/2 object-contain med-600:w-full" />
      </div>
