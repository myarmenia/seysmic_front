...
const ul_data1 = [
  ...
  "Если бы наша КТ мониторинга была бы взята официально на вооружение японскими сейсмологами и правительством, то землетрясение.",
];
const ul_data1_am = [
      ...
      return [
        {
          ...
          video: animateGif1,
          subtitle:
            "Visualization of the process of preparing a catastrophic earthquake",
          numbers: [
            {
              numbers: 222570,
              title: "Deaths",
...
const ImageBox = ({ title, img }) => {
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <img
        loading="lazy"
        className="max-w-[280px] med-900:w-full"
        src={img}
        alt=""
      />
    </div>
