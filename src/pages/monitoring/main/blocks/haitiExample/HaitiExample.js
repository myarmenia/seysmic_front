      ...
      return [
        {
          ...
          quake_desc: {
            ...
            red_text:
              "2011.03.11   05:46:23   38.32N  142.37W   H = 32 km    М = 9.0 ",
          },
        },
        {
          ...
          quake_desc: {
            ...
            red_text:
              "2010.01.12   21:53:10   18.46N   72.53W   H = 13 km    М = 7.2   ",
          },
        },
      ];
    } else if (lang === "am") {
      ...
      <div className="flex flex-col gap-[35px] med-1200:gap-[30px] med-900:gap-7 med-600:gap-5 py-5">
        ...
        <div className="gap-4 med-900:flex med-900:flex-col med-600:gap-2">
          <iframe
            ...
            allowFullScreen
            className="h-[277px] w-[390px] float-left pr-[25px] pb-[25px] med-900:pb-[15px] med-900:w-full med-900:p-0"></iframe>
